...
void protobuf_AddDesc_google_2fprotobuf_2fany_5ftest_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
const TestAny& TestAny::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_google_2fprotobuf_2fany_5ftest_2eproto();
...
// @@protoc_insertion_point(message_byte_size_start:protobuf_unittest.TestAny)
  ...
  // repeated .google.protobuf.Any repeated_any_value = 3;
  total_size += 1 * this->repeated_any_value_size();
  for (int i = 0; i < this->repeated_any_value_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
