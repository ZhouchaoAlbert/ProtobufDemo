...
#else
void protobuf_AddDesc_google_2fprotobuf_2funittest_5fproto3_5farena_5flite_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
const TestAllTypes_NestedMessage& TestAllTypes_NestedMessage::default_instance() {
  ...
  protobuf_AddDesc_google_2fprotobuf_2funittest_5fproto3_5farena_5flite_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_google_2fprotobuf_2funittest_5fproto3_5farena_5flite_2eproto();
#endif
...
::proto3_arena_lite_unittest::TestAllTypes_NestedMessage* TestAllTypes::_slow_release_optional_nested_message() {
  if (optional_nested_message_ == NULL) {
    ...
    ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage* temp = new ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage;
...
::proto3_arena_lite_unittest::ForeignMessage* TestAllTypes::_slow_release_optional_foreign_message() {
  if (optional_foreign_message_ == NULL) {
    ...
    ::proto3_arena_lite_unittest::ForeignMessage* temp = new ::proto3_arena_lite_unittest::ForeignMessage;
...
void TestAllTypes::InitAsDefaultInstance() {
...
#else
  optional_nested_message_ = const_cast< ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage*>(&::proto3_arena_lite_unittest::TestAllTypes_NestedMessage::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
#else
  optional_foreign_message_ = const_cast< ::proto3_arena_lite_unittest::ForeignMessage*>(&::proto3_arena_lite_unittest::ForeignMessage::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  ...
  optional_lazy_message_ = const_cast< ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage*>(
      ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage::internal_default_instance());
#else
  optional_lazy_message_ = const_cast< ::proto3_arena_lite_unittest::TestAllTypes_NestedMessage*>(&::proto3_arena_lite_unittest::TestAllTypes_NestedMessage::default_instance());
#endif
}
...
// @@protoc_insertion_point(message_byte_size_start:proto3_arena_lite_unittest.TestAllTypes)
  ...
  // repeated sint32 repeated_sint32 = 35;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_sint32_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated sint64 repeated_sint64 = 36;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_sint64_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated fixed32 repeated_fixed32 = 37;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_fixed32_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated fixed64 repeated_fixed64 = 38;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_fixed64_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated sfixed32 repeated_sfixed32 = 39;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_sfixed32_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated sfixed64 repeated_sfixed64 = 40;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_sfixed64_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated .proto3_arena_lite_unittest.TestAllTypes.NestedEnum repeated_nested_enum = 51;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_nested_enum_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
  ...
  // repeated .proto3_arena_lite_unittest.ForeignEnum repeated_foreign_enum = 52;
  {
    ...
    GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
    _repeated_foreign_enum_cached_byte_size_ = data_size;
    GOOGLE_SAFE_CONCURRENT_WRITES_END();
    total_size += data_size;
  }
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return optional_nested_message_ != NULL ? *optional_nested_message_ : *default_instance().optional_nested_message_;
#else
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return optional_foreign_message_ != NULL ? *optional_foreign_message_ : *default_instance().optional_foreign_message_;
#else
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return optional_import_message_ != NULL ? *optional_import_message_ : *default_instance().optional_import_message_;
#else
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return optional_public_import_message_ != NULL ? *optional_public_import_message_ : *default_instance().optional_public_import_message_;
#else
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return optional_lazy_message_ != NULL ? *optional_lazy_message_ : *default_instance().optional_lazy_message_;
#else
...
// @@protoc_insertion_point(message_byte_size_start:proto3_arena_lite_unittest.TestUnpackedTypes)
  ...
  // repeated int64 repeated_int64 = 2 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_int64_size() + data_size;
  }
  ...
  // repeated uint32 repeated_uint32 = 3 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_uint32_size() + data_size;
  }
  ...
  // repeated uint64 repeated_uint64 = 4 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_uint64_size() + data_size;
  }
  ...
  // repeated sint32 repeated_sint32 = 5 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_sint32_size() + data_size;
  }
  ...
  // repeated sint64 repeated_sint64 = 6 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_sint64_size() + data_size;
  }
  ...
  // repeated fixed64 repeated_fixed64 = 8 [packed = false];
  {
    int data_size = 0;
    data_size = 8 * this->repeated_fixed64_size();
    total_size += 1 * this->repeated_fixed64_size() + data_size;
  }
  ...
  // repeated sfixed32 repeated_sfixed32 = 9 [packed = false];
  {
    int data_size = 0;
    data_size = 4 * this->repeated_sfixed32_size();
    total_size += 1 * this->repeated_sfixed32_size() + data_size;
  }
  ...
  // repeated sfixed64 repeated_sfixed64 = 10 [packed = false];
  {
    int data_size = 0;
    data_size = 8 * this->repeated_sfixed64_size();
    total_size += 1 * this->repeated_sfixed64_size() + data_size;
  }
  ...
  // repeated float repeated_float = 11 [packed = false];
  {
    int data_size = 0;
    data_size = 4 * this->repeated_float_size();
    total_size += 1 * this->repeated_float_size() + data_size;
  }
  ...
  // repeated double repeated_double = 12 [packed = false];
  {
    int data_size = 0;
    data_size = 8 * this->repeated_double_size();
    total_size += 1 * this->repeated_double_size() + data_size;
  }
  ...
  // repeated bool repeated_bool = 13 [packed = false];
  {
    int data_size = 0;
    data_size = 1 * this->repeated_bool_size();
    total_size += 1 * this->repeated_bool_size() + data_size;
  }
  ...
  // repeated .proto3_arena_lite_unittest.TestAllTypes.NestedEnum repeated_nested_enum = 14 [packed = false];
  {
    ...
    total_size += 1 * this->repeated_nested_enum_size() + data_size;
  }
...
::proto3_arena_lite_unittest::NestedTestAllTypes* NestedTestAllTypes::_slow_release_child() {
  if (child_ == NULL) {
    ...
    ::proto3_arena_lite_unittest::NestedTestAllTypes* temp = new ::proto3_arena_lite_unittest::NestedTestAllTypes;
    temp->MergeFrom(*child_);
    child_ = NULL;
    return temp;
  }
}
...
::proto3_arena_lite_unittest::TestAllTypes* NestedTestAllTypes::_slow_release_payload() {
  if (payload_ == NULL) {
    ...
    ::proto3_arena_lite_unittest::TestAllTypes* temp = new ::proto3_arena_lite_unittest::TestAllTypes;
    temp->MergeFrom(*payload_);
    payload_ = NULL;
    return temp;
  }
}
...
#else
  child_ = const_cast< ::proto3_arena_lite_unittest::NestedTestAllTypes*>(&::proto3_arena_lite_unittest::NestedTestAllTypes::default_instance());
#endif
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
...
#else
  payload_ = const_cast< ::proto3_arena_lite_unittest::TestAllTypes*>(&::proto3_arena_lite_unittest::TestAllTypes::default_instance());
#endif
}
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return child_ != NULL ? *child_ : *default_instance().child_;
#else
