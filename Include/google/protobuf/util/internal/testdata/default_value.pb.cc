...
void protobuf_AddDesc_google_2fprotobuf_2futil_2finternal_2ftestdata_2fdefault_5fvalue_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
void DefaultValueTestCases::InitAsDefaultInstance() {
  ...
  empty_mixed2_ = const_cast< ::google::protobuf::testing::MixedMap2*>(&::google::protobuf::testing::MixedMap2::default_instance());
