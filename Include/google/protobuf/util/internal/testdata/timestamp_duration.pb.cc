...
void protobuf_AddDesc_google_2fprotobuf_2futil_2finternal_2ftestdata_2ftimestamp_5fduration_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
// @@protoc_insertion_point(message_clear_start:google.protobuf.testing.timestampduration.TimestampDuration)
...
// @@protoc_insertion_point(message_byte_size_start:google.protobuf.testing.timestampduration.TimestampDuration)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:google.protobuf.testing.timestampduration.TimestampDuration)
  ...
  const TimestampDuration* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const TimestampDuration>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:google.protobuf.testing.timestampduration.TimestampDuration)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:google.protobuf.testing.timestampduration.TimestampDuration)
    MergeFrom(*source);
  }
}

void TimestampDuration::MergeFrom(const TimestampDuration& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:google.protobuf.testing.timestampduration.TimestampDuration)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
  if (from.has_ts()) {
...
// @@protoc_insertion_point(generalized_copy_from_start:google.protobuf.testing.timestampduration.TimestampDuration)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:google.protobuf.testing.timestampduration.TimestampDuration)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Timestamp* TimestampDuration::release_ts() {
  // @@protoc_insertion_point(field_release:google.protobuf.testing.timestampduration.TimestampDuration.ts)
...
::google::protobuf::Duration* TimestampDuration::release_dur() {
  // @@protoc_insertion_point(field_release:google.protobuf.testing.timestampduration.TimestampDuration.dur)
