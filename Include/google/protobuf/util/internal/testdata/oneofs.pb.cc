...
void protobuf_AddDesc_google_2fprotobuf_2futil_2finternal_2ftestdata_2foneofs_2eproto() GOOGLE_ATTRIBUTE_COLD;
...
::google::protobuf::uint8* OneOfsRequest::InternalSerializeWithCachedSizesToArray(
  ...
  if (has_struct_data()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        5, *data_.struct_data_, false, target);
  }
  ...
  if (has_value_data()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        6, *data_.value_data_, false, target);
  }
  ...
  if (has_list_value_data()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        7, *data_.list_value_data_, false, target);
  }
