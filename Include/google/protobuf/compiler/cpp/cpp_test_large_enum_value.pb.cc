...
void protobuf_AssignDesc_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto() {
  ...
  TestLargeEnumValue_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      TestLargeEnumValue::default_instance_,
      TestLargeEnumValue_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(TestLargeEnumValue, _has_bits_[0]),
      -1,
      -1,
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      TestLargeEnumValue_descriptor_, &TestLargeEnumValue::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto() {
  delete TestLargeEnumValue::default_instance_;
  delete TestLargeEnumValue_reflection_;
}

void protobuf_AddDesc_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto() {
  ...
  TestLargeEnumValue::default_instance_ = new TestLargeEnumValue();
  TestLargeEnumValue::default_instance_->InitAsDefaultInstance();
...
const TestLargeEnumValue& TestLargeEnumValue::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_google_2fprotobuf_2fcompiler_2fcpp_2fcpp_5ftest_5flarge_5fenum_5fvalue_2eproto();
  return *default_instance_;
}

TestLargeEnumValue* TestLargeEnumValue::default_instance_ = NULL;
...
int TestLargeEnumValue::ByteSize() const {
