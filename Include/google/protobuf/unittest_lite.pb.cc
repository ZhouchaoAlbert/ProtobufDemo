...
void protobuf_ShutdownFile_google_2fprotobuf_2funittest_5flite_2eproto() {
  ...
  delete TestEmptyMessageLite::default_instance_;
  delete TestEmptyMessageWithExtensionsLite::default_instance_;
  delete V1MessageLite::default_instance_;
  delete V2MessageLite::default_instance_;
}

void protobuf_AddDesc_google_2fprotobuf_2funittest_5flite_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_google_2fprotobuf_2funittest_5flite_2eproto() {
  ...
  TestEmptyMessageLite::default_instance_ = new TestEmptyMessageLite();
  TestEmptyMessageWithExtensionsLite::default_instance_ = new TestEmptyMessageWithExtensionsLite();
  V1MessageLite::default_instance_ = new V1MessageLite();
  V2MessageLite::default_instance_ = new V2MessageLite();
  ...
  TestEmptyMessageLite::default_instance_->InitAsDefaultInstance();
  TestEmptyMessageWithExtensionsLite::default_instance_->InitAsDefaultInstance();
  V1MessageLite::default_instance_->InitAsDefaultInstance();
  V2MessageLite::default_instance_->InitAsDefaultInstance();
...
TestEmptyMessageLite* TestEmptyMessageLite::default_instance_ = NULL;
...
int TestEmptyMessageLite::ByteSize() const {
...
TestEmptyMessageWithExtensionsLite* TestEmptyMessageWithExtensionsLite::default_instance_ = NULL;
...
int TestEmptyMessageWithExtensionsLite::ByteSize() const {
...
V1MessageLite* V1MessageLite::default_instance_ = NULL;
...
int V1MessageLite::ByteSize() const {
...
V2MessageLite* V2MessageLite::default_instance_ = NULL;
...
int V2MessageLite::ByteSize() const {
