...
void protobuf_AddDesc_google_2fprotobuf_2funittest_5fmset_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_google_2fprotobuf_2funittest_5fmset_2eproto() {
  ...
  ::google::protobuf::internal::ExtensionSet::RegisterMessageExtension(
    &::proto2_wireformat_unittest::TestMessageSet::default_instance(),
...
void TestMessageSetExtension2::SharedDtor() {
  ...
  str_.Destroy(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), GetArenaNoVirtual());
  if (this != default_instance_) {
  }
}
...
int RawMessageSet_Item::RequiredFieldsByteSizeFallback() const {
